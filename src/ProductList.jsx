...
function ProductList({ onHomeClick }) {
    ...
    // Sync local "addedToCart" state with Redux cart
    useEffect(() => {
    const updated = {};
    cartItems.forEach(item => {
        updated[item.name] = true;
    });
    setAddedToCart(updated); // Only keep what's still in cart
    }, [cartItems]);
            ...
            {!showCart ? (
                <div className="product-grid">
                    ...
                    <div key={index}> {/* Unique key for each category div */}
                        <h1 style={{ textAlign: 'center', marginTop: '40px', marginBottom: '20px' }}>
                        {category.category}
                        </h1>
